...
<task type="checkpoint:human-verify">
  ...
  <how-to-verify>
    ...
    - Run README review: [@.Codex/skills/document-maintenance/rules/readme-review.md]
    - Run ARCHITECTURE.md review: [@.Codex/skills/document-maintenance/rules/architecture-review.md]
...
**Location:** `.Codex/skills/document-maintenance/`
