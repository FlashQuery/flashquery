...
- `.Codex/skills/flashquery-integration-testgen/SKILL.md` — where test bugs get fixed
- `.Codex/skills/flashquery-integration-covgen/SKILL.md` — where spec ambiguities get resolved
