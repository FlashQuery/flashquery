...
Returns JSON text with document identification for the moved document. Plugin-owned documents may include `warnings: ["plugin_ownership_path_expectation"]`. Expected errors cover missing or ambiguous sources, identical paths, destination conflicts, unsafe paths, untracked documents, and lock contention.
