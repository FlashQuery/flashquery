  ...
  server.registerTool(
    'query_graph',
    {
      ...
      inputSchema: {
        ...
        include_content: z.boolean().optional().describe('Include raw chunk content on returned node payloads. Default: true for action node, false for bulk actions; explicit true/false overrides.'),
