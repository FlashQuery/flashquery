...
import { readdir, readFile, stat, rename, mkdir, writeFile, rmdir, unlink } from 'node:fs/promises';
...
export function registerDocumentTools(server: McpServer, config: FlashQueryConfig): void {
  ...
  // ─── Tool 6: remove_directory (SPEC-07) ────────────────────────────────────
  ...
  // ─── Tool 7: reconcile_documents (DOC-08) ──────────────────────────────────
