  ...
  server.registerTool(
    ...
    async ({ identifier, destination }) => {
      ...
      try {
        ...
        // locks wrap withDocumentLocks, whose facade sorts canonical file locks.
        // The authoritative destination existence check stays inside that multi-lock.
