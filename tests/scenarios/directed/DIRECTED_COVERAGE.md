...
| D-71 | `get_llm_usage` `mode=by_purpose` public behavior remains stable after Phase 152 query typing cleanup. | test_get_llm_usage_by_purpose | 2026-05-25 | Pending |
| D-72 | `get_llm_usage` `mode=by_model` public behavior remains stable after Phase 152 grouping cleanup. | test_get_llm_usage_by_model | 2026-05-25 | Pending |
