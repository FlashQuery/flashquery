...
| IG-02 | Graph-enabled managed workflow returns graph-expanded `search` results with graph attribution from semantic seed chunks. | graph_search_expansion       | 2026-06-24   |              |
