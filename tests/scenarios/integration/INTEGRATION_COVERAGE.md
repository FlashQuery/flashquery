...
| IL-15  | call_model resolver=list_models returns {models: [...]} where each entry has name, provider, model_id, input_cost_per_million, output_cost_per_million (DISC-01 required fields) (PENDING)              | llm_discovery_list           | 2026-05-02   | -            |
| IL-16  | call_model resolver=list_models response includes the configured 'fast' model alias and the snake_case field names model_id, input_cost_per_million, output_cost_per_million (DISC-01 field mapping) (PENDING) | llm_discovery_list           | 2026-05-02   | -            |
| IL-17  | call_model resolver=list_purposes returns {purposes: [...]} including input_cost_per_million from the primary model in the purpose's models[] chain (DISC-02 primary-model cost lookup) (PENDING)                  | llm_discovery_list           | 2026-05-02   | -            |
| IL-18  | call_model resolver=list_models and resolver=list_purposes both succeed when called WITHOUT name and WITHOUT messages — schema makes them optional for discovery (DISC-04) (PENDING)                            | llm_discovery_list           | 2026-05-02   | -            |
| IL-19  | call_model resolver=search returns {query, results: {purposes, models}}; case-insensitive substring match; non-matching category returns [] (not omitted) (DISC-03 success + zero-match shape) (PENDING)        | llm_discovery_search         | 2026-05-02   | -            |
| IL-20  | call_model resolver=search with no parameters.query (or empty-string query) returns isError with "search requires parameters.query (non-empty string)" (DISC-03 missing-query path) (PENDING)                    | llm_discovery_search         | 2026-05-02   | -            |
