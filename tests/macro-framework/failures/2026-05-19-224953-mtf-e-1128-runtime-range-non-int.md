...
confidence: low
test_id: mtf-e-1128-runtime-range-non-int
test_file: cases/errors/1128-runtime-range-non-int.yml
covers: ["MTF-E-005"]
golden_version_used: 0.3.0
golden_version_current: 0.3.0
failed_at: "2026-05-19T22:49:53.949Z"
...
```json
{
  ...
  "message": "Range operands must be integers.",
  "details": {
...
- 2026-05-19T22:49:53.949Z — auto-classified by flashquery-macro-run (engine-bug, low confidence)
