...
confidence: low
test_id: mtf-s-994-input-var-in-string-interpolation
test_file: cases/semantics/994-input-var-in-string-interpolation.yml
covers: ["MTF-L-002", "MTF-C-009", "MTF-S-007"]
golden_version_used: 0.3.0
golden_version_current: 0.3.0
failed_at: "2026-05-19T22:12:05.153Z"
...
[
  {
    ...
    "expected": "success",
    "actual": "error",
    "detail": "payload.error = \"parse_error\"; payload = {\"error\":\"parse_error\",\"message\":\"Cannot assign to builtin name \\\"count\\\".\",\"details\":{\"reason\":\"builtin_name_shadowing\",\"at_line\":2,\"near_token\":\"count\"}}"
  },
  {
    "field": "return_result",
    "expected": {
      "message": "User Alice has 7 items"
    }
  }
]
```
...
{
  "error": "parse_error",
  "message": "Cannot assign to builtin name \"count\".",
  "details": {
...
- 2026-05-19T22:12:05.153Z — auto-classified by flashquery-macro-run (engine-bug, low confidence)
