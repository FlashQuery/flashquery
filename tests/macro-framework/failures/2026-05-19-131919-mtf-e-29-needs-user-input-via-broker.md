...
failed_at: "2026-05-19T13:19:19.389Z"
created_by: flashquery-macro-run
reviewed_by: ""
escalated_to: ""
related_failures: ["2026-05-19-122817-mtf-e-29-needs-user-input-via-broker.md", "2026-05-19-122907-mtf-e-29-needs-user-input-via-broker.md", "2026-05-19-123007-mtf-e-29-needs-user-input-via-broker.md", "2026-05-19-123029-mtf-e-29-needs-user-input-via-broker.md", "2026-05-19-123200-mtf-e-29-needs-user-input-via-broker.md", "2026-05-19-131644-mtf-e-29-needs-user-input-via-broker.md", "2026-05-19-131731-mtf-e-29-needs-user-input-via-broker.md"]
---
...
[
  {
    ...
    "actual": "reason=undefined error=\"tool_call_failed\""
  }
]
```
...
```json
{
  ...
  "message": "NeedsInputViaTofuDrift handler invoked — production should have short-circuited at the pre-dispatch pending-drift check.",
  "details": {
    "server": "approval_srv",
    "tool": "ask",
...
-----+-------------+--------------------------------------------------------
   ...
   3 | tofu_drift  | {"kind":"tofu_drift","server":"approval_srv","tool":"ask","phase":"dispatch"}
   4 | termination | {"kind":"termination","reason":"needs_user_input","event":"schema_drift_detected"}
```
...
- 2026-05-19T13:19:19.389Z — auto-classified by flashquery-macro-run (engine-bug, medium confidence)
