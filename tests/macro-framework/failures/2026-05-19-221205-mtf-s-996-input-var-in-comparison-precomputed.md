...
confidence: low
test_id: mtf-s-996-input-var-in-comparison-precomputed
test_file: cases/semantics/996-input-var-in-comparison-precomputed.yml
covers: ["MTF-L-002", "MTF-C-009", "MTF-N-005"]
golden_version_used: 0.3.0
golden_version_current: 0.3.0
failed_at: "2026-05-19T22:12:05.156Z"
...
[
  {
    ...
    "expected": "success",
    "actual": "error",
    "detail": "payload.error = \"parse_error\"; payload = {\"error\":\"parse_error\",\"message\":\"Cannot assign to builtin name \\\"count\\\".\",\"details\":{\"reason\":\"builtin_name_shadowing\",\"at_line\":1,\"near_token\":\"count\"}}"
  },
  {
    "field": "return_result",
    "expected": {
...
- 2026-05-19T22:12:05.156Z — auto-classified by flashquery-macro-run (engine-bug, low confidence)
