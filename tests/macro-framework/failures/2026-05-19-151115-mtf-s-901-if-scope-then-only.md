...
confidence: low
test_id: mtf-s-901-if-scope-then-only
test_file: cases/semantics/901-if-scope-then-only.yml
covers: ["MTF-S-101"]
golden_version_used: 0.3.0
golden_version_current: 0.3.0
failed_at: "2026-05-19T15:11:15.732Z"
created_by: flashquery-macro-run
reviewed_by: ""
escalated_to: ""
related_failures: ["2026-05-19-142312-mtf-s-901-if-scope-then-only.md", "2026-05-19-142408-mtf-s-901-if-scope-then-only.md", "2026-05-19-145140-mtf-s-901-if-scope-then-only.md", "2026-05-19-145150-mtf-s-901-if-scope-then-only.md", "2026-05-19-145355-mtf-s-901-if-scope-then-only.md", "2026-05-19-145543-mtf-s-901-if-scope-then-only.md", "2026-05-19-151043-mtf-s-901-if-scope-then-only.md", "2026-05-19-151052-mtf-s-901-if-scope-then-only.md"]
---
...
- 2026-05-19T15:11:15.732Z — auto-classified by flashquery-macro-run (engine-bug, low confidence)
