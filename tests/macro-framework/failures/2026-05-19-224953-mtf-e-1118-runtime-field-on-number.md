...
confidence: low
test_id: mtf-e-1118-runtime-field-on-number
test_file: cases/errors/1118-runtime-field-on-number.yml
covers: ["MTF-E-005"]
golden_version_used: 0.3.0
golden_version_current: 0.3.0
failed_at: "2026-05-19T22:49:53.927Z"
...
```json
{
  ...
  "message": "Cannot access .x on number.",
  "details": {
...
- 2026-05-19T22:49:53.927Z — auto-classified by flashquery-macro-run (engine-bug, low confidence)
