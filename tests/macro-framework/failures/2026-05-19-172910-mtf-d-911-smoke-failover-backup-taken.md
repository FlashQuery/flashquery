...
confidence: low
test_id: mtf-d-911-smoke-failover-backup-taken
test_file: cases/dispatch/911-smoke-failover-backup-taken.yml
covers: ["MTF-L-101", "MTF-S-101", "MTF-D-101", "MTF-C-009"]
golden_version_used: 0.3.0
golden_version_current: 0.3.0
failed_at: "2026-05-19T17:29:10.562Z"
...
[
  {
    ...
    "expected": "success",
    "actual": "error",
    "detail": "payload.error = \"unknown_server\"; payload = {\"error\":\"unknown_server\",\"message\":\"Unknown tool server 'primary_srv'.\",\"details\":{\"server\":\"primary_srv\",\"unknown\":[\"primary_srv.fetch\"]}}"
  },
  {
    "field": "return_result",
    "expected": {
...
```json
{
  ...
  "message": "Unknown tool server 'primary_srv'.",
  "details": {
    "server": "primary_srv",
    "unknown": [
      "primary_srv.fetch"
...
- 2026-05-19T17:29:10.562Z — auto-classified by flashquery-macro-run (engine-bug, low confidence)
