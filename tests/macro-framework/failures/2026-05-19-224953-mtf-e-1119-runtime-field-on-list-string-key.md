...
confidence: low
test_id: mtf-e-1119-runtime-field-on-list-string-key
test_file: cases/errors/1119-runtime-field-on-list-string-key.yml
covers: ["MTF-E-005"]
golden_version_used: 0.3.0
golden_version_current: 0.3.0
failed_at: "2026-05-19T22:49:53.930Z"
...
```json
{
  ...
  "message": "Cannot access .name on list.",
  "details": {
...
- 2026-05-19T22:49:53.930Z — auto-classified by flashquery-macro-run (engine-bug, low confidence)
