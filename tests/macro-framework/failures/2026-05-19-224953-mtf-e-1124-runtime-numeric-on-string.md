...
confidence: low
test_id: mtf-e-1124-runtime-numeric-on-string
test_file: cases/errors/1124-runtime-numeric-on-string.yml
covers: ["MTF-E-005"]
golden_version_used: 0.3.0
golden_version_current: 0.3.0
failed_at: "2026-05-19T22:49:53.940Z"
...
```json
{
  ...
  "message": "add expects numeric arguments.",
  "details": {
...
- 2026-05-19T22:49:53.940Z — auto-classified by flashquery-macro-run (engine-bug, low confidence)
