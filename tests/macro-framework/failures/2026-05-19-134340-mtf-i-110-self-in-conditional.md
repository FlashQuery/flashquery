...
confidence: low
test_id: mtf-i-110-self-in-conditional
test_file: cases/isolation/110-110-self-in-conditional.yml
covers: ["MTF-I-101"]
golden_version_used: 0.3.0
golden_version_current: 0.3.0
failed_at: "2026-05-19T13:43:40.789Z"
created_by: flashquery-macro-run
reviewed_by: ""
escalated_to: ""
related_failures: ["2026-05-19-134332-mtf-i-110-self-in-conditional.md"]
---
...
[
  {
    ...
    "expected": "success",
    "actual": "error",
    "detail": "payload.error = \"tool_call_failed\"; payload = {\"error\":\"tool_call_failed\",\"message\":\"Unknown builtin: true\",\"details\":{\"reason\":\"unknown_builtin\",\"name\":\"true\",\"line\":3}}"
  },
  {
    "field": "return_result",
    "expected": {
...
- 2026-05-19T13:43:40.789Z — auto-classified by flashquery-macro-run (engine-bug, low confidence)
