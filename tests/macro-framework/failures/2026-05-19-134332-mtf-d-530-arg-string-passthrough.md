...
failed_at: "2026-05-19T13:43:32.043Z"
...
```json
{
  "task_id": "9b4edc35-c7d3-4dd7-abb4-f9271ee27e69",
  "result": {
    "v": {
      "ok": true,
      "side_effect": "echo",
...
- 2026-05-19T13:43:32.043Z — auto-classified by flashquery-macro-run (spec-ambiguity, low confidence)
