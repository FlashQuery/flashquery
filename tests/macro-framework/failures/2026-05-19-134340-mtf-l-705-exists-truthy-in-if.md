...
confidence: low
test_id: mtf-l-705-exists-truthy-in-if
test_file: cases/lifecycle/705-705-exists-truthy-in-if.yml
covers: ["MTF-L-101"]
golden_version_used: 0.3.0
golden_version_current: 0.3.0
failed_at: "2026-05-19T13:43:40.808Z"
created_by: flashquery-macro-run
reviewed_by: ""
escalated_to: ""
related_failures: ["2026-05-19-134332-mtf-l-705-exists-truthy-in-if.md"]
---
...
[
  {
    ...
    "expected": "success",
    "actual": "error",
    "detail": "payload.error = \"parse_error\"; payload = {\"error\":\"parse_error\",\"message\":\"Expected \\\"then\\\" after if condition.\",\"details\":{\"reason\":\"missing_then\",\"at_line\":1,\"near_token\":\"(\"}}"
  },
  {
    "field": "return_result",
    "expected": {
...
- 2026-05-19T13:43:40.808Z — auto-classified by flashquery-macro-run (engine-bug, low confidence)
