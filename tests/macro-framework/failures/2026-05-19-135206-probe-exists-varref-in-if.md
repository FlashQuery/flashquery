...
confidence: low
test_id: probe-exists-varref-in-if
test_file: cases/lifecycle/_probe-exists-syntax.yml
covers: ["MTF-L-101"]
golden_version_used: 0.3.0
golden_version_current: 0.3.0
failed_at: "2026-05-19T13:52:06.374Z"
...
[
  {
    ...
    "expected": "success",
    "actual": "error",
    "detail": "payload.error = \"parse_error\"; payload = {\"error\":\"parse_error\",\"message\":\"Expected \\\"then\\\" after if condition.\",\"details\":{\"reason\":\"missing_then\",\"at_line\":2,\"near_token\":\"(\"}}"
  },
  {
    "field": "return_result",
    "expected": {
...
- 2026-05-19T13:52:06.374Z — auto-classified by flashquery-macro-run (engine-bug, low confidence)
