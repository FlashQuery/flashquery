...
confidence: low
test_id: mtf-e-1126-runtime-count-non-list
test_file: cases/errors/1126-runtime-count-non-list.yml
covers: ["MTF-E-005"]
golden_version_used: 0.3.0
golden_version_current: 0.3.0
failed_at: "2026-05-19T22:49:53.944Z"
...
```json
{
  ...
  "message": "count expects a list, string, or null.",
  "details": {
...
- 2026-05-19T22:49:53.944Z — auto-classified by flashquery-macro-run (engine-bug, low confidence)
