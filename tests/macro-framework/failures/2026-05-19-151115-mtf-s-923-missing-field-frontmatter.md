...
confidence: low
test_id: mtf-s-923-missing-field-frontmatter
test_file: cases/semantics/923-missing-field-frontmatter.yml
covers: ["MTF-S-102", "MTF-I-101"]
golden_version_used: 0.3.0
golden_version_current: 0.3.0
failed_at: "2026-05-19T15:11:15.744Z"
created_by: flashquery-macro-run
reviewed_by: ""
escalated_to: ""
related_failures: ["2026-05-19-145355-mtf-s-923-missing-field-frontmatter.md", "2026-05-19-145543-mtf-s-923-missing-field-frontmatter.md", "2026-05-19-151043-mtf-s-923-missing-field-frontmatter.md", "2026-05-19-151052-mtf-s-923-missing-field-frontmatter.md"]
---
...
[
  {
    ...
    "expected": "success",
    "actual": "error",
    "detail": "payload.error = \"tool_call_failed\"; payload = {\"error\":\"tool_call_failed\",\"message\":\"Missing field .workspace.\",\"details\":{\"reason\":\"missing_field\",\"field\":\"workspace\"}}"
  },
  {
    "field": "return_result",
    "expected": {
...
```json
{
  ...
  "message": "Missing field .workspace.",
  "details": {
...
- 2026-05-19T15:11:15.744Z — auto-classified by flashquery-macro-run (engine-bug, low confidence)
