...
confidence: low
test_id: mtf-e-1125-runtime-iter-non-list
test_file: cases/errors/1125-runtime-iter-non-list.yml
covers: ["MTF-E-005"]
golden_version_used: 0.3.0
golden_version_current: 0.3.0
failed_at: "2026-05-19T22:49:53.942Z"
...
```json
{
  ...
  "message": "For-loop iterable must be a list.",
  "details": {
...
- 2026-05-19T22:49:53.942Z — auto-classified by flashquery-macro-run (engine-bug, low confidence)
