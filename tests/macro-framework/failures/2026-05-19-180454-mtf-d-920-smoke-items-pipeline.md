...
confidence: low
test_id: mtf-d-920-smoke-items-pipeline
test_file: cases/dispatch/920-smoke-items-pipeline.yml
covers: ["MTF-I-101", "MTF-S-001", "MTF-C-001", "MTF-D-101", "MTF-S-007", "MTF-C-009"]
golden_version_used: 0.3.0
golden_version_current: 0.3.0
failed_at: "2026-05-19T18:04:54.700Z"
...
[
  {
    ...
    "expected": "success",
    "actual": "error",
    "detail": "payload.error = \"parse_error\"; payload = {\"error\":\"parse_error\",\"message\":\"Expected object key.\",\"details\":{\"reason\":\"unexpected_token\",\"at_line\":14,\"near_token\":\"done\"}}"
  },
  {
    "field": "return_result",
    "expected": {
...
- 2026-05-19T18:04:54.700Z — auto-classified by flashquery-macro-run (engine-bug, low confidence)
