...
confidence: low
test_id: mtf-s-1148-numeric-div-float
test_file: cases/semantics/1148-numeric-div-float.yml
covers: ["MTF-C-009", "MTF-N-005"]
golden_version_used: 0.3.0
golden_version_current: 0.3.0
failed_at: "2026-05-19T22:52:11.580Z"
...
```json
{
  "task_id": "a11124c9-28ea-417b-881f-9dcbf4e47f3d",
  "result": {
    "n": 2
  },
  "trace": [
...
- 2026-05-19T22:52:11.580Z — auto-classified by flashquery-macro-run (engine-bug, low confidence)
