...
const config: KnipConfig = {
  ...
  ignoreIssues: {
    ...
    'src/embedding/chunks/scheduler.ts': ['types'],
    'src/graph/candidates.ts': ['types'],
    'src/graph/config.ts': ['exports'],
    'src/graph/edge-analysis.ts': ['exports', 'types'],
    'src/graph/edge-validation.ts': ['types'],
    'src/graph/link-resolver.ts': ['types'],
    'src/graph/lint-categories.ts': ['types'],
    'src/graph/node-analysis.ts': ['exports', 'types'],
    'src/graph/pending-worker.ts': ['types'],
    'src/graph/queries.ts': ['types'],
    'src/graph/response.ts': ['types'],
    'src/graph/schemas.ts': ['exports'],
    'src/graph/structural.ts': ['exports'],
    'src/graph/vocabulary.ts': ['types'],
