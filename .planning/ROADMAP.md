...
- [ ] 141-02-PLAN.md — `TOOL_META` loader and validator primitives
- [ ] 141-03-PLAN.md — Dispatcher `help:true`, native error footer, and brokered pass-through semantics
- [ ] 141-04-PLAN.md — Core memory/document/search `.tool.md` help pages
...
- [ ] 141-09-PLAN.md — Records and plugin `.tool.md` help pages
- [ ] 141-10-PLAN.md — LLM, macro, vault/editing, and `search_tools` `.tool.md` help pages
- [ ] 141-11-PLAN.md — Startup enforcement and native registration descriptions from `TOOL_META`
