...
- [x] **Phase 166: Embedding Pipeline** — Write path (parallel per-entry + pending queue); rate limiting + 429 backoff; search + RRF fusion; plugin-table integration (Spec §8 Phase 2, sub-steps 2.1 → 2.2 → 2.3 → 2.4)
...
**Plans**: 7 plans
- [ ] 167-01-PLAN.md — Lifecycle contract and max_rows validation
- [ ] 167-02-PLAN.md — Durable lifecycle job, lock, status, heartbeat, and abort foundation
- [ ] 167-03-PLAN.md — Core backfill/rebuild lifecycle processing and maintain_vault dispatch
- [ ] 167-04-PLAN.md — Retire transaction and maintain_vault dispatch
- [ ] 167-05-PLAN.md — Records-scope and mixed-scope lifecycle execution
- [ ] 167-06-PLAN.md — Lifecycle lock, heartbeat, and abort directed scenarios
- [ ] 167-07-PLAN.md — Operator recipe scenarios, coverage matrices, and example config
...
| 166. Embedding Pipeline | 4/4 | Complete | 2026-06-11 |
