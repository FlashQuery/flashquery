...
| 123 | Document Read + Standard Output Migration | 1/4 | In Progress|  |
...
- [ ] 123-02-PLAN.md — Migrate `archive_document` JSON output and persisted `archived_at` semantics.
- [ ] 123-03-PLAN.md — Migrate `copy_document` and `move_document` JSON identification outputs.
