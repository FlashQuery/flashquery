...
| 127 | Removal, Directory, And Vault Maintenance | 1/6 | In Progress|  |
...
- [ ] 127-02-PLAN.md — Implement `manage_directory(action:"create" | "remove")` with ordered JSON, locks, and integration coverage.
- [ ] 127-03-PLAN.md — Implement `maintain_vault(action)` with sync, repair, status, background, and conflict behavior.
