...
- [x] **REQ-005**: Direct `pg` usage for records is pooled. Record embedding updates and semantic `search_records` vector SQL borrow from a process-scoped pool or equivalent abstraction that preserves IPv4 behavior and owns release/shutdown handling.
