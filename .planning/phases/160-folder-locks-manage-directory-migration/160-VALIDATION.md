...
| 160-04-01 | 04 | 4 | REQ-007 | T-160-07 | `INT-WCO-01` scenario passes a public write plus `manage_directory` rename/move workflow | scenario | `python3 tests/scenarios/integration/run_integration.py --managed folder_coordination` | yes | green |
