...
| 120-03-01 | 03 | 1 | VAL-120, TEST-04 | T-120-03 | Directed closure asserts public MCP JSON only and does not inspect private internals | directed | `python3 tests/scenarios/directed/run_suite.py --managed <atl-directed-tests>` | ✅ partial | ⬜ pending |
