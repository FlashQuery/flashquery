...
| Phase 135 injected dispatch/test seam | Public `call_macro` builds real native registry and dispatch context | Phase 135 complete | Cancellation must respect in-flight native handler behavior. [VERIFIED: .planning/phases/135-tool-registry-dispatch-permissions/135-04-SUMMARY.md] |
