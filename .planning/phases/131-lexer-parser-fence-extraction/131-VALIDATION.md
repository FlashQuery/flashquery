...
| 131-03-02 | 03 | 2 | MACRO-PARSE-04, MACRO-PARSE-05, MACRO-PARSE-06, MACRO-PARSE-07, MACRO-PARSE-08, MACRO-PARSE-10 | T-131-09, T-131-10, T-131-11 | Operators, `..`, `range` builtin syntax, and control flow produce stable AST shapes, not ad hoc runtime interpretation | unit | `npm test -- --run tests/unit/macro-parser.test.ts` | no - W0 | pending |
| 131-03-03 | 03 | 2 | MACRO-PARSE-09 | T-131-10 | Tool-call grammar rejects ambiguous dotted server syntax without dispatching tools | unit | `npm test -- --run tests/unit/macro-parser.test.ts` | no - W0 | pending |
