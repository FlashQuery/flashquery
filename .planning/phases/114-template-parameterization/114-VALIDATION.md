...
- `npm run build && npm test -- tests/unit/reference-resolver.test.ts tests/unit/llm-tool.test.ts && npm run test:integration -- tests/integration/reference-resolver.integration.test.ts && python3 tests/scenarios/directed/run_suite.py --managed --strict-cleanup test_call_model_template_parameterization` — passed on 2026-05-06 after DRS gap closure: build succeeded; unit tests passed 129/129; integration tests passed 8/8; directed scenario passed 1/1 suite with 5/5 steps and strict cleanup clean.
