...
- `npm run build && npm test -- tests/unit/reference-resolver.test.ts tests/unit/llm-tool.test.ts && npm run test:integration -- tests/integration/reference-resolver.integration.test.ts && python3 tests/scenarios/directed/run_suite.py --managed --strict-cleanup test_call_model_template_parameterization` — passed on 2026-05-06: build succeeded; unit tests passed 123/123; integration tests passed 8/8; directed scenario passed 1/1 suite with 4/4 steps and strict cleanup clean.
